...
function _createTodo() {
  _createTodo = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(todo) {
    var response;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.n = 1;
          return axios.post("".concat(baseURL, "/create"), todo);
        case 1:
          response = _context.v;
...
function _getAllTodo() {
  _getAllTodo = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
    var response;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _context2.n = 1;
          return axios.get("".concat(baseURL, "/getAll"));
        case 1:
...
function putTodo(_x2, _x3) {
  return _putTodo.apply(this, arguments);
}
function _putTodo() {
  _putTodo = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(id, todo) {
    var response;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          _context3.n = 1;
          return axios.put("".concat(baseURL, "/update/").concat(id), todo);
        case 1:
  ...
  _deleteTodo = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(id) {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.n) {
        case 0:
          _context4.n = 1;
          return axios["delete"]("".concat(baseURL, "/delete/").concat(id));
        case 1:
